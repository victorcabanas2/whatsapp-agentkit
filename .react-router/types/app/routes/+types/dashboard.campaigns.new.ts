...
type Module = typeof import("../dashboard.campaigns.new.js")

type Info = GetInfo<{
  file: "routes/dashboard.campaigns.new.jsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../dashboard.campaigns.js");
}, {
  id: "routes/dashboard.campaigns.new";
  module: typeof import("../dashboard.campaigns.new.js");
}];
